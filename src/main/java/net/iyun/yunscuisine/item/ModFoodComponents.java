...
public class ModFoodComponents {
    ...
    public static final FoodComponent BUTTEREDBAKEDPOTATO = new FoodComponent.Builder().nutrition(5).saturationModifier(0.25f).build();
    ...
    public static final FoodComponent BOILEDEGG = new FoodComponent.Builder().nutrition(4).saturationModifier(0.5f).build();
    public static final FoodComponent GARLICBREAD = new FoodComponent.Builder().nutrition(4).saturationModifier(0.8f).build();
    public static final FoodComponent GLOBALMAGICBERRIES = new FoodComponent.Builder().nutrition(5).saturationModifier(1.3f).alwaysEdible().build();
    public static final FoodComponent MASHEDPOTATO = new FoodComponent.Builder().nutrition(5).saturationModifier(0.15f).build();
    public static final FoodComponent TRUFFLE = new FoodComponent.Builder().nutrition(4).saturationModifier(0.5f).build();
    public static final FoodComponent PIZZA = new FoodComponent.Builder().nutrition(6).saturationModifier(0.25f).build();
    ...
    public static final FoodComponent GLOBALCAKES = new FoodComponent.Builder().nutrition(9).saturationModifier(0.55f).build();
    ...
    public static final FoodComponent TOASTBACON = new FoodComponent.Builder().nutrition(4).saturationModifier(0.3f).build();
    ...
    public static final FoodComponent GLOBALPIE = new FoodComponent.Builder().nutrition(6).saturationModifier(0.3f).build();
    public static final FoodComponent CROISSANT = new FoodComponent.Builder().nutrition(5).saturationModifier(0.3f).build();
    public static final FoodComponent DOUGHNUT = new FoodComponent.Builder().nutrition(4).saturationModifier(0.25f).build();
    public static final FoodComponent NIGIRISUSHI = new FoodComponent.Builder().nutrition(5).saturationModifier(0.5f).build();
    public static final FoodComponent VEGGIEMAKI = new FoodComponent.Builder().nutrition(5).saturationModifier(0.25f).build();
    public static final FoodComponent VEGGIESANDWICH = new FoodComponent.Builder().nutrition(6).saturationModifier(0.25f).build();
    ...
    public static final FoodComponent STEAKANDPOTATO = new FoodComponent.Builder().nutrition(6).saturationModifier(0.35f).build();
    ...
    public static final FoodComponent DUMPLING = new FoodComponent.Builder().nutrition(5).saturationModifier(0.5f).build();
   ...
   // public static final FoodComponent DEBUG = new FoodComponent.Builder().nutrition(1).saturationModifier(.5f).alwaysEdible().usingConvertsTo(Items.DIAMOND).build();
    ...
    public static final FoodComponent PEARLSTEW = new FoodComponent.Builder().nutrition(5).saturationModifier(0.2f).build();
    public static final FoodComponent BUTTERCORN = new FoodComponent.Builder().nutrition(4).saturationModifier(0.25f).build();
    ...
    public static final FoodComponent BLAZERODNOODLES = new FoodComponent.Builder().nutrition(6).saturationModifier(0.125f).statusEffect(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 400 ,0),0.3f).build();
    ...
    public static final FoodComponent GLOBALPICKELS = new FoodComponent.Builder().nutrition(5).saturationModifier(0.25f).build();
