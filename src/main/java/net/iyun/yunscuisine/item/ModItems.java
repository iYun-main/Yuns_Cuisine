...
import net.iyun.yunscuisine.item.custom.*;
...
public class ModItems {
    ...
    private static Item registerItem(String name, Item item){
        return Registry.register(Registries.ITEM, Identifier.of(Yuns_Cuisine.MOD_ID, name), item);
    }

    public static void registerModItems() {Yuns_Cuisine.LOGGER.info("Spawning Items for " + Yuns_Cuisine.MOD_ID);
    }
}
