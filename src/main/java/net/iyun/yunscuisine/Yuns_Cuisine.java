...
public class Yuns_Cuisine implements ModInitializer {
	...
	public void onInitialize() {
        ...
        CompostingChanceRegistry.INSTANCE.add(ModItems.ANCIENTFRUIT,0.3f);
        CompostingChanceRegistry.INSTANCE.add(ModItems.LETTUCELEAF,0.05f);
        CompostingChanceRegistry.INSTANCE.add(ModItems.CORNSEEDS,0.2f);
        CompostingChanceRegistry.INSTANCE.add(ModItems.CORN,0.2f);
        CompostingChanceRegistry.INSTANCE.add(ModItems.HOPS,0.2f);
        CompostingChanceRegistry.INSTANCE.add(ModItems.HOPSEEDS,0.2f);
        ...
        CompostingChanceRegistry.INSTANCE.add(ModItems.WHITEALGAE,0.3f);
        CompostingChanceRegistry.INSTANCE.add(ModItems.GREENALGAE,0.3f);
        ...
        CompostingChanceRegistry.INSTANCE.add(ModItems.RUHBARBSEEDS,0.3f);
        CompostingChanceRegistry.INSTANCE.add(ModItems.ANCIENTSEEDS,0.3f);
        ...
        CompostingChanceRegistry.INSTANCE.add(ModItems.RAWONIONRING,0.05f);
