...
//Food Crafting
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.FOOD, ModItems.RAWFISH,2)
                .input(ModTags.Items.FISHY)
                .criterion(hasItem(Items.SALMON), conditionsFromItem(ModItems.RAWFISH))
                .criterion(hasItem(Items.COD), conditionsFromItem(ModItems.RAWFISH))
                .criterion(hasItem(Items.TROPICAL_FISH), conditionsFromItem(ModItems.RAWFISH))
                .criterion(hasItem(Items.COOKED_SALMON), conditionsFromItem(ModItems.RAWFISH))
                .criterion(hasItem(Items.COOKED_COD), conditionsFromItem(ModItems.RAWFISH))
                .criterion(hasItem(ModItems.COOKEDREDSNAP), conditionsFromItem(ModItems.RAWFISH))
                .criterion(hasItem(ModItems.COOKEDHERRING), conditionsFromItem(ModItems.RAWFISH))
                .criterion(hasItem(ModItems.COOKED_TUNA), conditionsFromItem(ModItems.RAWFISH))
                .criterion(hasItem(ModItems.TUNA), conditionsFromItem(ModItems.RAWFISH))
                .criterion(hasItem(ModItems.HERRING), conditionsFromItem(ModItems.RAWFISH))
                .criterion(hasItem(ModItems.REDSNAP), conditionsFromItem(ModItems.RAWFISH))
                .offerTo(exporter, Identifier.of(getRecipeName(ModItems.RAWFISH)));

        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.KINGCRABCAKES)
                .pattern("NIG")
                .pattern("GER")
                .input('G', ModItems.KINGCRAB)
                .input('E', ModItems.DOUGH)
                .input('R', ModItems.SALT)
                .input('I', ModItems.PARSLEY)
                .input('N', ModItems.MOLTENSUGAR)
                .criterion(hasItem(ModItems.KINGCRAB), conditionsFromItem(ModItems.KINGCRABCAKES))
                .criterion(hasItem(ModItems.DOUGH), conditionsFromItem(ModItems.KINGCRABCAKES))
                .criterion(hasItem(ModItems.SALT), conditionsFromItem(ModItems.KINGCRABCAKES))
                .criterion(hasItem(ModItems.PARSLEY), conditionsFromItem(ModItems.KINGCRABCAKES))
                .criterion(hasItem(ModItems.MOLTENSUGAR), conditionsFromItem(ModItems.KINGCRABCAKES))
                .offerTo(exporter, Identifier.of(getRecipeName(ModItems.KINGCRABCAKES)));

        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.SQUIDINKRAV)
                .pattern("NIG")
                .pattern("GER")
                .input('G', ModItems.SQUID)
                .input('E', ModItems.DOUGH)
                .input('R', ModItems.SALT)
                .input('I', ModItems.PARSLEY)
                .input('N', ModItems.OYSTER)
                .criterion(hasItem(ModItems.SQUID), conditionsFromItem(ModItems.SQUIDINKRAV))
                .criterion(hasItem(ModItems.RAWFISH), conditionsFromItem(ModItems.SQUIDINKRAV))
                .criterion(hasItem(ModItems.DOUGH), conditionsFromItem(ModItems.SQUIDINKRAV))
                .criterion(hasItem(ModItems.SALT), conditionsFromItem(ModItems.SQUIDINKRAV))
                .criterion(hasItem(ModItems.PARSLEY), conditionsFromItem(ModItems.SQUIDINKRAV))
                .offerTo(exporter, Identifier.of(getRecipeName(ModItems.SQUIDINKRAV)));

        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.SEAJELLPUD)
                .pattern("TVU")
                .pattern(" G ")
                .input('T', ModItems.SEAJELLY)
                .input('U', ModItems.GREENALGAE)
                .input('V', ModItems.WHITEALGAE)
                .input('G', Items.BOWL)
                .criterion(hasItem(Items.BOWL), conditionsFromItem(ModItems.SEAJELLPUD))
                .criterion(hasItem(ModItems.GREENALGAE), conditionsFromItem(ModItems.SEAJELLPUD))
                .criterion(hasItem(ModItems.WHITEALGAE), conditionsFromItem(ModItems.SEAJELLPUD))
                .criterion(hasItem(ModItems.SEAJELLY), conditionsFromItem(ModItems.SEAJELLPUD))
                .offerTo(exporter, Identifier.of(getRecipeName(ModItems.SEAJELLPUD)));

        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.OYSTERSTEW)
                .pattern("TVU")
                .pattern(" G ")
                .input('T', ModItems.OYSTER)
                .input('U', ModItems.GREENALGAE)
                .input('V', ModItems.WHITEALGAE)
                .input('G', Items.BOWL)
                .criterion(hasItem(Items.BOWL), conditionsFromItem(ModItems.OYSTERSTEW))
                .criterion(hasItem(ModItems.GREENALGAE), conditionsFromItem(ModItems.OYSTERSTEW))
                .criterion(hasItem(ModItems.WHITEALGAE), conditionsFromItem(ModItems.OYSTERSTEW))
                .criterion(hasItem(ModItems.OYSTER), conditionsFromItem(ModItems.OYSTERSTEW))
                .offerTo(exporter, Identifier.of(getRecipeName(ModItems.OYSTERSTEW)));

        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.FISHSTEW)
                .pattern("TVU")
                .pattern(" G ")
                .input('T', ModTags.Items.FISHY)
                .input('U', ModItems.GREENALGAE)
                .input('V', ModItems.WHITEALGAE)
                .input('G', Items.BOWL)
                .criterion(hasItem(Items.BOWL), conditionsFromItem(ModItems.FISHSTEW))
                .criterion(hasItem(ModItems.GREENALGAE), conditionsFromItem(ModItems.FISHSTEW))
                .criterion(hasItem(ModItems.WHITEALGAE), conditionsFromItem(ModItems.FISHSTEW))
                .criterion(hasItem(ModItems.OYSTER), conditionsFromItem(ModItems.FISHSTEW))
                .offerTo(exporter, Identifier.of(getRecipeName(ModItems.FISHSTEW)));

        ShapelessRecipeJsonBuilder.create(RecipeCategory.FOOD, ModItems.MAKIROLL,3)
                .input(ModItems.RAWFISH,1)
                .input(Items.CARROT,1)
                .input(ModItems.ONION,1)
                .input(ModItems.BELLPEPPERSLICE,1)
                .input(ModItems.SALT,1)
                .input(ModItems.RICE,1)
                .input(Items.DRIED_KELP,1)
                .criterion(hasItem(Items.DRIED_KELP), conditionsFromItem(ModItems.MAKIROLL))
                .criterion(hasItem(Items.CARROT), conditionsFromItem(ModItems.MAKIROLL))
                .criterion(hasItem(ModItems.RAWFISH), conditionsFromItem(ModItems.MAKIROLL))
                .criterion(hasItem(ModItems.BELLPEPPERSLICE), conditionsFromItem(ModItems.MAKIROLL))
                .criterion(hasItem(ModItems.ONION), conditionsFromItem(ModItems.MAKIROLL))
                .criterion(hasItem(ModItems.SALT), conditionsFromItem(ModItems.MAKIROLL))
                .criterion(hasItem(ModItems.RICE), conditionsFromItem(ModItems.MAKIROLL))
                .offerTo(exporter, Identifier.of(getRecipeName(ModItems.MAKIROLL)));

        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.LOBSTERRISOTTO)
                .pattern("TVU")
                .pattern("O L")
                .pattern(" G ")
                .input('T', ModItems.LOBSTER)
                .input('U', ModItems.GREENALGAE)
                .input('O', ModItems.KINGCRAB)
                .input('V', ModItems.WHITEALGAE)
                .input('L', ModItems.RICE)
                .input('G', Items.BOWL)
                .criterion(hasItem(Items.BOWL), conditionsFromItem(ModItems.LOBSTERRISOTTO))
                .criterion(hasItem(ModItems.GREENALGAE), conditionsFromItem(ModItems.LOBSTERRISOTTO))
                .criterion(hasItem(ModItems.LOBSTER), conditionsFromItem(ModItems.LOBSTERRISOTTO))
                .criterion(hasItem(ModItems.KINGCRAB), conditionsFromItem(ModItems.LOBSTERRISOTTO))
                .criterion(hasItem(ModItems.WHITEALGAE), conditionsFromItem(ModItems.LOBSTERRISOTTO))
                .criterion(hasItem(ModItems.RICE), conditionsFromItem(ModItems.LOBSTERRISOTTO))
                .offerTo(exporter, Identifier.of(getRecipeName(ModItems.LOBSTERRISOTTO)));

        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.SHRIMPRICE)
                .pattern("TVT")
                .pattern(" G ")
                .input('T', ModItems.RICE)
                .input('V', ModItems.SHRIMP)
                .input('G', Items.BOWL)
                .criterion(hasItem(Items.BOWL), conditionsFromItem(ModItems.SHRIMPRICE))
                .criterion(hasItem(ModItems.SHRIMP), conditionsFromItem(ModItems.SHRIMPRICE))
                .criterion(hasItem(ModItems.RICE), conditionsFromItem(ModItems.SHRIMPRICE))
                .offerTo(exporter, Identifier.of(getRecipeName(ModItems.SHRIMPRICE)));

        ShapelessRecipeJsonBuilder.create(RecipeCategory.FOOD, ModItems.SHRIMPCTAIL,1)
                .input(ModItems.SHRIMP)
                .input(ModItems.WHISKEY)
                .criterion(hasItem(ModItems.WHISKEY), conditionsFromItem(ModItems.SHRIMPCTAIL))
                .criterion(hasItem(ModItems.SHRIMP), conditionsFromItem(ModItems.SHRIMPCTAIL))
                .offerTo(exporter, Identifier.of(getRecipeName(ModItems.SHRIMPCTAIL)));

        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.CLAMCHOW)
                .pattern("TVU")
                .pattern(" G ")
                .input('T', ModItems.CLAM)
                .input('U', ModItems.GREENALGAE)
                .input('V', ModItems.WHITEALGAE)
                .input('G', Items.BOWL)
                .criterion(hasItem(Items.BOWL), conditionsFromItem(ModItems.CLAMCHOW))
                .criterion(hasItem(ModItems.GREENALGAE), conditionsFromItem(ModItems.CLAMCHOW))
                .criterion(hasItem(ModItems.WHITEALGAE), conditionsFromItem(ModItems.CLAMCHOW))
                .criterion(hasItem(ModItems.CLAM), conditionsFromItem(ModItems.CLAMCHOW))
                .offerTo(exporter, Identifier.of(getRecipeName(ModItems.CLAMCHOW)));
